...
nb <- train_nb(c1b_train_t, c1b_val_t)
...
c2_res <- train_classifiers(c2, useMetrics = F)
...
c2_res_metrics <- train_classifiers(c2, useMetrics = T)
```

## Metrics

```{r}
c1b_perf <- get_performance(c1b_res)
```
